...
#define ZABBIX_VERSION_REVISION	48483
#define ZABBIX_VERSION_WEB_CHECK       " with item web.check"
...
#define ZABBIX_REVISION		ZBX_STR(ZABBIX_VERSION_REVISION) ZABBIX_VERSION_WEB_CHECK
